extends RunQuality
class_name AllMultiQuality

## AllMultiQuality: Applies MULTI/PER_ROUND modifier to every bag tile at round start.
## Bundled by MultiDeck; NOT registered in QualityRegistry (not shown in UI quality list).
##
## on_round_started:
##   Precondition : TileBag._available_tiles is populated.
##   Postcondition: every tile in TileBag._available_tiles carries a MULTI/PER_ROUND modifier.
...
func get_description() -> String:
	return "All tiles carry the Multi modifier each round."
...
func on_round_started(_round_number: int) -> void:
	_apply_multi_to_all_bag_tiles()

# =============================================================================
# PRIVATE
# =============================================================================

func _apply_multi_to_all_bag_tiles() -> void:
