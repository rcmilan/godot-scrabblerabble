extends RunQuality
class_name AllExtraQuality

## AllExtraQuality: Applies EXTRA/PER_ROUND modifier to every bag tile at round start.
## Bundled by ExtraDeck; NOT registered in QualityRegistry (not shown in UI quality list).
##
## on_round_started:
##   Precondition : TileBag._available_tiles is populated.
##   Postcondition: every tile in TileBag._available_tiles carries a EXTRA/PER_ROUND modifier.
...
func get_description() -> String:
	return "All tiles carry the Extra modifier each round."
...
func on_round_started(_round_number: int) -> void:
	_apply_extra_to_all_bag_tiles()

# =============================================================================
# PRIVATE
# =============================================================================

func _apply_extra_to_all_bag_tiles() -> void:
